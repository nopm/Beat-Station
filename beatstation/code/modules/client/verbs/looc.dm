...
//                    display_name = holder.fakekey
            to_chat(C,"<font color='#6699CC'><span class='bold'><span class='prefix'>LOOC:</span> <EM>[src.mob.name]:</EM> <span class='message'>[msg]</span></span></font>")
    ...
    for(var/client/C in GLOB.admins)
        if(C.prefs.toggles & CHAT_OOC)
            ...
            if (C.mob in heard)
                prefix = "LOOC"
            to_chat(C,"<font color='#6699CC'><span class='bold'><span class='prefix'>[prefix]:</span> <EM>[src.mob.name] ([src.key)]:</EM> <span class='message'>[msg]</span>[ADMIN_FLW(usr)]</span></font>")
