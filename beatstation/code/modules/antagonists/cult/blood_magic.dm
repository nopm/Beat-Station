/datum/action/innate/cult/blood_spell/manipulation
	...
	charges = 5
	magic_path = "/obj/item/melee/blood_magic/manipulator_beat"

/obj/item/melee/blood_magic/manipulator_beat
...
/obj/item/melee/blood_magic/manipulator_beat/examine(mob/user)
	. = ..()
...
/obj/item/melee/blood_magic/manipulator_beat/afterattack(atom/target, mob/living/carbon/human/user, proximity)
	if(proximity)
		if(ishuman(target))
...
/obj/item/melee/blood_magic/manipulator_beat/proc/draw_blood(atom/target, mob/living/carbon/human/user)
	var/temp = 0
...
/obj/item/melee/blood_magic/manipulator_beat/attack_self(mob/living/user)
	if(iscultist(user))
