...
SUBSYSTEM_DEF(research)
	...
	var/list/techweb_nodes_experimental = list()	//Node ids that are exclusive to the BEPIS. // beat -- bepis
...
/datum/controller/subsystem/research/proc/calculate_techweb_nodes()
	...
	for(var/node_id in techweb_nodes)
		...
		if(node.experimental) // beat start -- bepis
			techweb_nodes_experimental[node.id] = TRUE // beat end
		CHECK_TICK
