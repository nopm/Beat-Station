/obj/item/storage/wallet
	...
	component_type = /datum/component/storage/concrete/wallet // beat

	var/obj/item/card/id/front_id = null
	var/obj/item/card/id/cached_front_id = null // beat
	var/list/combined_access
	var/cached_flat_icon // beat

/obj/item/storage/wallet/ComponentInitialize()
	. = ..()
	var/datum/component/storage/STR = GetComponent(/datum/component/storage/concrete/wallet) // beat
	STR.max_items = 4
...
/*/obj/item/storage/wallet/update_icon()	// beat start
...
/obj/item/storage/wallet/examine()
	. = ..()
	if(front_id)
		. += "<span class='notice'>Alt-click to remove the id.</span>"	// beat end
